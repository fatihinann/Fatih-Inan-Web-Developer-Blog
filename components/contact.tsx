...
import { Mail, MapPin, Send, Github, Instagram, Headphones, Film } from 'lucide-react';
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {submitStatus === 'success' && (
                    <p className="text-green-500 text-center mt-4">
                      {t('contact.message.successMessage') || 'Mesajınız başarıyla gönderildi!'}
                    </p>
                  )}
                  {submitStatus === 'error' && (
                    <p className="text-red-500 text-center mt-4">
                      {t('contact.message.errorMessage') || 'Bir hata oluştu. Lütfen tekrar deneyin.'}
                    </p>
                  )}
                </form>
              </CardContent>
